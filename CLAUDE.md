...
- **Карточки Anki привязываются к правилам по дню, а не по счёту слов.** 10 слов
  и 2 правила в день — значит 5 слов на правило. Тег карточки несёт день
  (`frequentie::kern::dagNN`), день совпадает с `due_date` правила.
