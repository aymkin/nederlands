# Robinson op kantoor — Een zaterdag zonder telefoon
...
Hij **heeft** zijn laptop op het werk **vergeten**.
...
De deur van het gebouw **staat** open.
...
"De schoonmaker **is** er vandaag," **denkt** Mark.
...
Mark **loopt** naar de tweede verdieping.
...
Zijn laptop **ligt** op het bureau.
...
Hij **pakt** de laptop en **stopt** die in zijn tas.
...
Dan **hoort** hij een geluid beneden.
...
Hij **trekt** aan de deur, maar die **is** gesloten.
...
Hij **trekt** nog een keer — het **lukt** niet.
...
"Oké, geen paniek," **zegt** hij.

<details><summary>📖 zegt</summary>

_«Окей, без паники», — говорит он._ _zeggen_ — presens (→ уже встречалось).

</details>

Mark **pakt** zijn telefoon.

<details><summary>📖 pakt</summary>

_Марк берёт телефон._ _pakken_ — presens (→ уже встречалось).
...
Hij **zoekt** een **oplader** in zijn tas.
...
"Eerst eten en drinken **zoeken**," **zegt** hij.
...
Want hij **weet** niet hoe lang hij hier **blijft**.
...
Mark **denkt** aan Robinson Crusoë.
...
Die **zat** ook alleen — op een eiland.
...
"Maar Robinson **had** geen kantine," **zegt** Mark.
...
Hij **loopt** naar de kantine.

<details><summary>📖 loopt</summary>

_Он идёт в столовую._ _lopen_ — presens (→ уже встречалось).
...
_Холодильник почти пустой._ _zijn_ — presens. "Bijna" = почти.

</details>

Maar er **staan** twee boterhammen met kaas.
...
In de kast **vindt** hij een appel.
...
"Mijn **voorraad** voor vandaag!" **zegt** Mark.
...
In de keuken **vindt** hij koffie en thee.
...
De magnetron en het koffiezetapparaat **werken** nog.
...
"Op het eiland **had** Robinson geen koffie," **zegt** Mark.
...
Hij **maakt** een kop koffie en **eet** een boterham.
...
_Кофе тёплый и вкусный._ _zijn_ — presens (→ уже встречалось).

</details>

Mark **voelt** zich iets beter.
...
"Goed," **zegt** hij. "Ik **heb** genoeg **voorraad**."
...
"Nu **moet** ik hier weg **zien** te **komen**."
...
Na de koffie **loopt** Mark door het gebouw.
...
Maar niemand **hoort** hem, want het **is** zaterdag.
...
Mark **schreeuwt**: "Hallo! **Is** er iemand?"
...
_Тишина._ Нет глагола — одно слово создаёт атмосферу. Эффект: пустота, тишина.

</details>

Mark **voelt** zich net als Robinson.
...
Hij **gaat** naar de eerste verdieping.

<details><summary>📖 gaat</summary>

_Он идёт на первый этаж._ _gaan_ — presens (→ уже встречалось).

</details>

Alle ramen **zijn** dicht en **zitten** op slot.
...
Mark **wil** een raam **openen**, maar het **lukt** niet.
...
Een deur met een groen bord: **NOODUITGANG**.
...
Mark **duwt** tegen de **nooduitgang**.
...
Mark **gaat** terug naar de kantine.
...
Hij **eet** de appel en **drinkt** melk.
...
"Robinson **kon** tenminste naar buiten," **denkt** hij.
...
"Ik **zit** **opgesloten** in een gebouw met verwarming."
...
"Robinson **had** niet eens een stoel!"
...
_Уже полдень._ _zijn_ — presens. "Al" = уже.

</details>

Mark **zit** in de kantine en **kijkt** naar buiten.
...
Er **klopt** iemand op de deur beneden!
...
"Hallo!" **schreeuwt** hij. "Ik **zit** hier!"
...
Hij **loopt** naar het raam en **klopt** op het glas.
...
Beneden **staat** een man in een uniform.
...
De **bewaker** **kijkt** omhoog en **ziet** Mark.
...
"Hé!" **roept** de **bewaker**. "Wat **doe** je daar?"
...
"De deur **is** dicht en mijn **batterij** **is** leeg!"
...
De **bewaker** **lacht** en **pakt** zijn sleutels.
...
Na twee minuten **is** de deur open.
...
Net als de vriend van Robinson Crusoë.
...
"Bedankt!" **zegt** hij. "Ik **heb** hier lang **gezeten**."
...
De **bewaker** **zegt**: "Dat **gebeurt** vaak."
...
"Mensen **vergeten** dat de deur op slot **gaat**."
...
"**Neem** altijd een **oplader** mee," **zegt** hij.
...
Mark **staat** buiten in de zon.

<details><summary>📖 staat</summary>

_Марк стоит на улице на солнце._ _staan_ — presens (→ уже встречалось).

</details>

De frisse lucht **voelt** heerlijk.
...
Hij **pakt** zijn fiets en **lacht**.

<details><summary>📖 pakt, lacht</summary>

_Он берёт велосипед и смеётся._ _pakken_ — presens. _lachen_ — presens.

</details>

"Ik **ben** geen Robinson meer," **zegt** hij.
...
"Maar een **oplader** **neem** ik voortaan mee."
...
"En misschien ook een extra boterham."
...
| ------------------ | -------------------- | -------------- |
| **opgesloten**     | заперт(ый)           | locked in      |
| de **batterij**    | батарея, аккумулятор | battery        |
| **vastzitten**     | застрять             | to be stuck    |
| de **nooduitgang** | аварийный выход      | emergency exit |
| de **oplader**     | зарядное устройство  | charger        |
| de **bewaker**     | охранник             | security guard |
| **kloppen** (op)   | стучать (в)          | to knock (on)  |
| de **voorraad**    | запас(ы)             | supply, stock  |
| **schreeuwen**     | кричать              | to shout       |
