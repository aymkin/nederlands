# Thema 17: Ik Zoek Werk — Grammatica
...
- Ik **zocht** een leuk cadeau voor je **uit**.
- Ik **kwam** om 10 uur **aan**.
- Ze **stonden** in het weekend laat **op**.
- De pijn **ging** vanzelf **over**.
- We **deden** de deur voor hem **open**.
- Ze **gaven** op reis erg veel geld **uit**.
- Onze vrienden **kwamen** bij ons **langs**.
- John **gaf** zijn zoontje voor zwemles **op**.
- Mijn zus **viel** vorig jaar tien kilo **af**.
